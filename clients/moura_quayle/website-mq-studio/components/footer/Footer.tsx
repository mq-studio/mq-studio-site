            ...
            <div className="flex gap-3 justify-center">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 rounded bg-[var(--ink-black)] text-white flex items-center justify-center hover:bg-[var(--moura-teal)] transition-colors"
                ...
                >
                  ...
                  {social.icon === 'instagram' && (
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22.4C6.374 22.4 1.6 17.626 1.6 12S6.374 1.6 12 1.6s10.4 4.774 10.4 10.4-4.774 10.4-10.4 10.4zm3.2-13.6c0 .884-.716 1.6-1.6 1.6s-1.6-.716-1.6-1.6.716-1.6 1.6-1.6 1.6.716 1.6 1.6zm2.8 7.2c0 2.546-2.054 4.6-4.6 4.6H7.6c-2.546 0-4.6-2.054-4.6-4.6v-5.6c0-2.546 2.054-4.6 4.6-4.6h5.6c2.546 0 4.6 2.054 4.6 4.6v5.6zm-1.6-5.6c0-1.663-1.337-3-3-3H8.8c-1.663 0-3 1.337-3 3v5.6c0 1.663 1.337 3 3 3h5.6c1.663 0 3-1.337 3-3v-5.6z" />
                    </svg>
                  )}
                </a>
              ))}
