...
(async () => {
  ...
  // Take screenshot
  await page.screenshot({ path: "/tmp/publications_page_fixed.png", fullPage: false });
  console.log('[SCREENSHOT] Saved to /tmp/publications_page_fixed.png');
  ...
  console.log('Has publication cards: ' + hasCards);
